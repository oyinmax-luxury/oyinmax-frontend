...
//             <div>
//               <h1 className="text-5xl font-light font-luxury text-brand-dark mb-6">Get in Touch</h1>
...
//                 <input type="text" placeholder="First Name" className="w-full p-3 border-b focus:border-brand-gold outline-none transition" />
//                 <input type="text" placeholder="Last Name" className="w-full p-3 border-b focus:border-brand-gold outline-none transition" />
//               </div>
//               <input type="email" placeholder="Email Address" className="w-full p-3 border-b focus:border-brand-gold outline-none transition" />
//               <textarea placeholder="How can we assist you?" rows="4" className="w-full p-3 border-b focus:border-brand-gold outline-none transition resize-none"></textarea>
//               <button className="w-full bg-brand-dark text-white py-4 rounded-sm uppercase tracking-[0.2em] text-xs hover:bg-brand-gold transition duration-500">
//                 Send Message
//               </button>
//             </form>
//           </div>
